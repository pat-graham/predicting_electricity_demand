...
generator <- timeseries_generator(r.aggregate.mat, targets=r.aggregate.mat, length = 672, batch_size = 10)
generator_test <- timeseries_generator(r.aggregate.mat.test, targets=r.aggregate.mat.test, length = 672, batch_size = 10)
