...
ggplot() + 
  ...
  xlab("Year") + ylab("Aggregate Demand MWh") + ggtitle("Long View ARIMA Performance on Test Set with Real Outcome") +
  theme(plot.title = element_text(hjust = 0.5))

ggplot() + 
  geom_line(aes(x = aggregate_demand[test_index,1], y = benchmark_forecast$mean, color = "forecast")) +
  geom_line(aes(x = aggregate_demand[test_index,1], y = aggregate_demand[test_index,2], color = "test"), alpha = 1/2) +
  xlab("Year") + ylab("Aggregate Demand MWh") + ggtitle("ARIMA Performance on Test Set with Real Outcome") +
  theme(plot.title = element_text(hjust = 0.5))
